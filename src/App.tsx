          ...
          <>
            {view === 'portal' && (
              ...
              >
                ...
                <div className={`grid grid-cols-1 ${isUser1512 ? 'md:grid-cols-4' : 'md:grid-cols-3'} gap-4`}>
                  {/* 1. sb */}
                  <motion.div 
                    whileHover={{ scale: 1.01 }}
                    whileTap={{ scale: 0.99 }}
                    onClick={() => setView('dashboard')}
                    className="bg-[#111] border border-white/10 hover:border-white/20 rounded-xl p-6 cursor-pointer transition-colors group relative overflow-hidden flex flex-col justify-between"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-[11px] font-mono text-zinc-500 font-semibold px-2 py-0.5 rounded bg-white/5 border border-white/5">
                          1. sb
                        </span>
                      </div>
                      <h2 className="text-base font-semibold text-white mb-2 group-hover:text-indigo-400 transition-colors">sb</h2>
                      <p className="text-xs text-zinc-400 leading-relaxed font-normal">
                        Main user automation console. Manage rich presence, remote operations, server tools, and token operations.
                      </p>
                    </div>
                    <div className="mt-6 flex items-center gap-1.5 text-xs text-zinc-500 group-hover:text-zinc-300 font-mono">
                  ...
                  <motion.div 
                    ...
                    whileTap={{ scale: 0.99 }}
                    onClick={() => setView('sb2')}
                    className="bg-[#111] border border-red-500/20 hover:border-red-500/40 rounded-xl p-6 cursor-pointer transition-colors group relative overflow-hidden flex flex-col justify-between"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-[11px] font-mono text-red-400 font-semibold px-2 py-0.5 rounded bg-red-500/10 border border-red-500/20">
                          2. sb 2
                        </span>
                      </div>
                      <h2 className="text-base font-semibold text-white mb-2 group-hover:text-red-400 transition-colors">sb 2</h2>
                      <p className="text-xs text-zinc-400 leading-relaxed font-normal">
                        Corrupt-Ware App-Commands method. Setup tutorial, authorization, interactive /help command embed simulator, and media.
                      </p>
                    </div>
                    <div className="mt-6 flex items-center gap-1.5 text-xs text-red-400/80 group-hover:text-red-400 font-mono">
                      <span>View tutorial & /help</span>
                      <ChevronRight className="w-3.5 h-3.5" />
                    </div>
                  </motion.div>
                  ...
                  >
                    <div>
                      ...
                      <h2 className="text-base font-semibold text-white mb-2 group-hover:text-indigo-400 transition-colors">yuri cord</h2>
                      <p className="text-xs text-zinc-400 leading-relaxed font-normal">
                        Connect directly to the socket to interoperate across guild and private channels dynamically.
                      </p>
                    </div>
                    <div className="mt-6 flex items-center gap-1.5 text-xs text-zinc-500 group-hover:text-zinc-300 font-mono">
                      <span>Open Yuri Cord</span>
                      <ChevronRight className="w-3.5 h-3.5" />
                    </div>
                  </motion.div>
                  ...
                  {isUser1512 && (
                    <motion.div 
                      ...
                      className="bg-[#111] border border-amber-500/20 hover:border-amber-500/40 rounded-xl p-6 cursor-pointer transition-colors group relative overflow-hidden flex flex-col justify-between"
                    >
                      <div>
                        <div className="flex items-center justify-between mb-4">
                        ...
                        <h2 className="text-base font-semibold text-white mb-2 group-hover:text-amber-400 transition-colors">Admin Dashboard</h2>
                        <p className="text-xs text-zinc-400 leading-relaxed font-normal">
                          Access control logs, telemetry sessions, and system parameters across daemon hosts.
                        </p>
                      </div>
                      <div className="mt-6 flex items-center gap-1.5 text-xs text-amber-400/80 group-hover:text-amber-400 font-mono">
