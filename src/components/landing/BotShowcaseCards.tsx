  ...
  const BOTS: BotInfo[] = [
    {
      ...
      inviteUrl: 'https://discord.com/oauth2/authorize?client_id=1545528232898465893&permissions=8&integration_type=1&scope=applications.commands'
    }
  ];
